class CustomerModel {
  ...
  factory CustomerModel.fromJson(Map<String, dynamic>? json) {
    ...
    return CustomerModel(
      ...
      contact: json['contact'] ?? json['contactName'],
      stationId: json['stationId']?.toString() ?? json['station_id']?.toString(),
      balance: _parseDouble(json['balance'] ?? json['owedAmount']),
      ticketCount: json['ticketCount'] ?? json['tickets'],
      owedBarrels: json['owedBarrels'] ?? json['owed_buckets'],
      type: json['type'] ?? json['typeText'],
