...
class _CustomerDetailPageState extends State<CustomerDetailPage> {
  ...
  final Map<String, dynamic> _customerData = {
    ...
    'ticketRecords': [
      {'type': '购买', 'count': 20, 'date': '04-10', 'orderId': ''},
      {
        ...
        'count': -5,
        'date': '04-15',
        'orderId': '#ORD2026041502'
      },
      {
        'type': '订单抵扣',
        'count': -3,
        'date': '04-12',
        'orderId': '#ORD2026041201'
      },
    ],
    'orderHistory': [
      {
    ...
    return AppCard(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildInfoRow(
              '剩余水票', '${_customerData['ticketCount']} 张', AppColors.success),
          const SizedBox(height: 12),
          _buildInfoRow('欠桶数量', '${_customerData['oweBucketCount']} 个',
              AppColors.warning),
        ],
      ),
    );
    ...
    return AppCard(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              _buildStatItem('累计订单', '${_customerData['totalOrders']} 单',
                  AppColors.primary),
              _buildStatItem('累计消费', '¥${_customerData['totalConsumption']}',
                  AppColors.success),
              _buildStatItem('累计桶数', _customerData['totalBuckets'] as String,
                  AppColors.purple),
            ],
          ),
          const SizedBox(height: 16),
  ...
  Widget _buildTicketRecordsCard() {
    final records =
        _customerData['ticketRecords'] as List<Map<String, dynamic>>;
