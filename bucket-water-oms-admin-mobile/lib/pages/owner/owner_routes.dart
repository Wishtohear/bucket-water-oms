...
import 'owner_dispatch_page.dart';
...
class OwnerRoutes {
  ...
  static const String ownerDispatch = '/owner/owner-dispatch';
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case ownerDispatch:
        final args = settings.arguments as Map<String, dynamic>?;
        return MaterialPageRoute(
          builder: (_) => OwnerDispatchPage(
            orderId: args?['orderId'] ?? '',
            orderData: args?['orderData'] as OrderModel?,
          ),
        );
      default:
        return MaterialPageRoute(
