...
class _RechargePageState extends State<RechargePage> {
  ...
  Future<void> _submitRecharge() async {
    ...
    try {
      final request = RechargeRequest(
        ...
        paymentMethod: _selectedPaymentMethod == 0 ? 'wechat' : 'bank',
        giftAmount: _giftAmount.toString(),
      );

      final response = await _stationService.recharge(request);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomSheet:
          _isLoading || _errorMessage != null ? null : _buildBottomAction(),
    );
  }
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  Text(
                    '¥${(_stationInfo?.balance ?? 0).toStringAsFixed(2).replaceAllMapped(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 4),
                      Text(
                        '¥${((_stationInfo?.creditLimit ?? 0) - (_stationInfo?.usedCredit ?? 0)).toStringAsFixed(0)}',
                        style: const TextStyle(
                            fontSize: 18,
                            fontWeight: FontWeight.bold,
                            color: Colors.white),
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 4),
                      Text(
                        _stationInfo?.paymentTypeText ?? '月结',
                        style: const TextStyle(
                            fontSize: 18,
                            fontWeight: FontWeight.bold,
                            color: Colors.white),
        ...
        children: [
          ...
          GridView.count(
            ...
            children: List.generate(5, (index) {
              final isSelected =
                  !_showCustomInput && _selectedAmountIndex == index;
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('最低充值金额 ¥100', style: AppTextStyles.captionSmall),
                      Text('最高充值金额 ¥100,000',
                          style: AppTextStyles.captionSmall),
                    ],
                  ),
    ...
    return AppCard(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          _buildSummaryRow('赠送金额', '+¥${_giftAmount.toStringAsFixed(2)}',
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text('将从月结额度扣除', style: AppTextStyles.captionSmall),
                ],
              ),
            ],
          ),
  ...
  Widget _buildPaymentOption(int index, String title, String subtitle,
      IconData icon, bool isRecommended) {
    ...
    return Container(
      ...
      child: SafeArea(
        child: Column(
          ...
          children: [
            GestureDetector(
              onTap: _isSubmitting ? null : _submitRecharge,
              child: Container(
            ...
            const SizedBox(height: 8),
            Text('24小时到账，如有问题请联系客服', style: AppTextStyles.captionSmall),
          ],
        ),
      ),
    );
